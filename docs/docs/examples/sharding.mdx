...
util.on('DJSeed::Cluster_Util_Info', (i) => console.log('[DJSeed::Cluster_Util_Info]:', i));
util.on('DJSeed::Cluster_Util_Error', (i) => console.log('[DJSeed::Cluster_Util_Error]:', i));
util.on('DJSeed::Cluster_Ready', (i) => console.log('[DJSeed::Cluster_Ready]:', i));
util.on('DJSeed::Cluster_Death', (i) => console.log('[DJSeed::Cluster_Death]:', i));
util.on('DJSeed::Cluster_Error', (i) => console.log('[DJSeed::Cluster_Error]:', i));
util.on('DJSeed::Cluster_Warn', (i) => console.log('[DJSeed::Cluster_Warn]:', i));
util.on('DJSeed::Shard_Ready', (i) => console.log('[DJSeed::Shard_Ready]:', i));
util.on('DJSeed::Shard_Resume', (i) => console.log('[DJSeed::Shard_Resume]:', i));
util.on('DJSeed::Shard_Reconnecting', (i) => console.log('[DJSeed::Shard_Reconnecting]:', i));
util.on('DJSeed::Shard_Disconnect', (i) => console.log('[DJSeed::Shard_Disconnect]:', i));
util.on('DJSeed::Shard_Error', (i) => console.log('[DJSeed::Shard_Error]:', i));
